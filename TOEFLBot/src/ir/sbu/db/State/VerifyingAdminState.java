...
public class VerifyingAdminState implements BotState
{

    private long chatId;
    MainController mainController;
    public VerifyingAdminState(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    public void validate(Update update)
    {
        if(update.getMessage().getText().length()<25)
        {
            ...
            this.changeState("verifyingAdmin");
