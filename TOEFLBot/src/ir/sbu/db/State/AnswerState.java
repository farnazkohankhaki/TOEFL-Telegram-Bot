 ...
 */
public class AnswerState implements BotState
{

    private long chatId;
    MainController mainController;
    public AnswerState(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    public void validate(Update update)
    {
        ...
        {
            String message = "Truuuuuue!";
            if (!update.getMessage().getText().equals(mainController.qans))
                message = "Wrongggg!\nAnswer is:" + mainController.qans;
