...
public class AddWordState implements BotState
{

    private long chatId;
    MainController mainController;
    public AddWordState(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    public void validate(Update update)
    {
        ...
        {
            String message = "Enter New Word";
            String keyboardMessage = "";
            this.changeState("addWord");
