 ...
 */
public class IdiomQuestionState implements BotState
{
    private long chatId;
    MainController mainController;
    public IdiomQuestionState(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    public void validate(Update update)
    {
        ...
        {
            IdiomQuestion question = new IdiomQuestion();
            IdiomQuestionModel questionModel = question.getQuestion(this.chatId);
            ...
            this.changeState("idiomQuestion");
