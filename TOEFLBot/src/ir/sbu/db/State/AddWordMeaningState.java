...
public class AddWordMeaningState implements BotState
{

    private long chatId;
    MainController mainController;
    public AddWordMeaningState(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    public void validate(Update update)
    {
        ...
        {
            String message = "Enter Word Meaning";
            String keyboardMessage = "";
            this.changeState("addWordMeaning");
