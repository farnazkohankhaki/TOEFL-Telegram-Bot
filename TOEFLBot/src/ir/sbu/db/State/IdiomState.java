 ...
 */
public class IdiomState implements BotState
{

    private long chatId;
    MainController mainController;
    public IdiomState(MainController mainController, long chatId)
    {
        this.chatId = chatId;
    ...
    public void validate(Update update)
    {
        if(update.getMessage().getText().length() < 20)
        {
            ...
            IdiomModel idiomModel = idiom.getIdiom(this.chatId);
            String message = "" + idiomModel.getSentence() + ": " + idiomModel.getMeaning();
            String keyboardMessage = "Ok";
            this.changeState("idiom");
