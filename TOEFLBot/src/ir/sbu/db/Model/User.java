...
public class User {
    ...
    public static Boolean insert(UserModel userModel){
        ...
        try {
            String query = "INSERT INTO `User` (`id`,`aliasName`, `state`, `email`, `wordCount`, `idiomCount`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            preparedStatement.setLong(5, userModel.getWordCount());
            preparedStatement.setLong(6, userModel.getIdiomCount());
    ...
    public static List<UserModel> getAll(){
        ...
        try {
            ...
            while (result.next()) {
                userModelList.add(new UserModel(result.getLong("id"), result.getString("aliasName"), result.getString("state"), result.getString("email"), result.getLong("wordCount"), result.getLong("idiomCount")));
            }
    ...
    public static String getwordCount(long value){
        Connection dbCon = MysqlHelper.connect();
        String state = "";
